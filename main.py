...
st.set_page_config(page_title="CU Finance: Credit Risk Modelling", page_icon="📊")
st.title("CU Finance: Credit Risk Modelling")
...
if st.button('Calculate Risk'):
    # print((age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency, delinquency_ratio,
...
# Footer
# st.markdown('_CU MSDS Major Project_')